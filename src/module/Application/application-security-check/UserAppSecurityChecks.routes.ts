import UserAppSecurityChecksController from "./UserAppSecurityChecks.controller";
import { Router } from 'express';

const UserAppSecurityChecksrouter = Router();
/**
 * @swagger
 * /API/UserAppSecurityCheckss:
 *   get:
 ...
 */
UserAppSecurityChecksrouter.get("/", UserAppSecurityChecksController.getUserAppSecurityCheckss);
/**
 * @swagger
 * /API/UserAppSecurityCheckss:
 *   post:
 ...
 *         description: Erreur interne du serveur.
 */
UserAppSecurityChecksrouter.post("/", UserAppSecurityChecksController.createUserAppSecurityCheckss);
/**
 * @swagger
 * /API/UserAppSecurityCheckss/{id}:
 *   put:
 ...
 *         description: Erreur interne du serveur.
 */
UserAppSecurityChecksrouter.put("/:id", UserAppSecurityChecksController.updateUserAppSecurityCheckss);
/**
 * @swagger
 * /API/UserAppSecurityCheckss/{id}:
 *   delete:
 ...
 *         description: Erreur interne du serveur.
 */
UserAppSecurityChecksrouter.delete("/:id", UserAppSecurityChecksController.deleteUserAppSecurityCheckss);

export default UserAppSecurityChecksrouter;
