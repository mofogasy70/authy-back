 ...
 */
Redirectrouter.get("/", RedirectController.getRedirects);
/**
 * @swagger
 * /API/Roles:
 *   post:
 ...
 *         description: Erreur interne du serveur.
 */
Redirectrouter.post("/", RedirectController.createRedirects);


Redirectrouter.get("/:id", RedirectController.findRedirects);
/**
 * @swagger
 * /API/Redirects:
 *   post:
 ...
 *         description: Erreur interne du serveur.
 */
Redirectrouter.put("/:id", RedirectController.updateRedirects);
/**
 * @swagger
 * /API/Redirects/{id}:
 *   delete:
 ...
 *         description: Erreur interne du serveur.
 */
Redirectrouter.delete("/:id", RedirectController.deleteRedirects);
