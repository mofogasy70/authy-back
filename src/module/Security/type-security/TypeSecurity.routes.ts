...
import TypeSecurityController from './TypeSecurity.controller';

const TypeSecurityrouter = Router();
/**
 * @swagger
 * /API/TypeSecuritys:
 *   get:
 ...
 */
TypeSecurityrouter.get("/", TypeSecurityController.getTypeSecuritys);
/**
 * @swagger
 * /API/TypeSecuritys:
 *   post:
 ...
 *         description: Erreur interne du serveur.
 */
TypeSecurityrouter.post("/",TypeSecurityController.createTypeSecuritys);
/**
 * @swagger
 * /API/TypeSecuritys/{id}:
 *   put:
 ...
 *         description: Erreur interne du serveur.
 */
TypeSecurityrouter.put("/:id", TypeSecurityController.updateTypeSecuritys);
/**
 * @swagger
 * /API/TypeSecuritys/{id}:
 *   delete:
 ...
 *         description: Erreur interne du serveur.
 */
TypeSecurityrouter.delete("/:id", TypeSecurityController.deleteTypeSecuritys);
/**
 * @swagger
 * /API/TypeSecuritys:
 *   get:
 ...
 *         description: Erreur interne du serveur.
 */
TypeSecurityrouter.post("/TypeSecuritysWithChild", TypeSecurityController.FindTypeSecuritysWithChild);

export default TypeSecurityrouter;
